...
class ReportByDateExport implements FromView
{
    /**
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('pdf.excel', [
            ...
            'customer_by_sales' => customer::whereBetween('created_at', [$this->start_date, $this->end_date])->where('user_id', $by_user)->get(),
            'progress'=> $progress
        ]);
    }

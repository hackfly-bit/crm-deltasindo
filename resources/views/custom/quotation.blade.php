                            ...
                            <div class="d-flex justify-content-end">
                                <form action="{{ route('generateReportByModel') }}">
                                    <div class="row align-items-center g-3">
                                        ...
                                        <input type="text" name="model" class="form-control" value="quotation" hidden>
                                        <div class="col-auto">
                            ...
                            <tbody>
                                @foreach ($sph as $x)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('sph.edit', ['customer_id' => $x->customer->id, 'id' => $x->id]) }}"
                                        ...
                                        <td><a class="btn btn-warning btn-xs"
                                                href="{{ asset('assets/pdf/' . $x->pdf_file) }}" target="_blank">File</a>
                                        </td>
                                        <td>{{ $x->time_line }}</td>
                                        @if ($x->status == 'Done')

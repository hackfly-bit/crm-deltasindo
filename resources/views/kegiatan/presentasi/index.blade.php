                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-tambah" method="post"
                            action="{{ route('presentasi.update', $presentasi_edit->id) }}">
                            @method('put')
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select" id="customer" name="customer">
                                        <option selected value="{{ $presentasi_edit->customer_id }}">
                                            {{ $presentasi_edit->customer->nama_customer }}</option>
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group flatpickr" id="flatpickr-date">
                                        <input type="text" class="form-control" placeholder="Pilih Tanggal Kegiatan"
                                            name="tanggal" data-input value="{{ $presentasi_edit->tanggal,old('tanggal') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select" id="pertemuan" name="pertemuan">
                                        <option selected value="{{ $presentasi_edit->pertemuan }}">Pertemuan ke-{{ $presentasi_edit->pertemuan }}</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="note" autocomplete="off" placeholder="Note Kegiatan" rows="4"
                                        name="note"> {{$presentasi_edit->note ,old('note') }}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-tambah" method="post" action="{{ route('presentasi.store') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select" id="customer" name="customer">
                                        <option selected value="{{ $customer->id }}">{{ $customer->nama_customer }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <tbody>
                                @foreach ($presentasi as $x)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('presentasi.edit', ['customer_id' => $x->customer->id, 'id' => $x->id]) }}"

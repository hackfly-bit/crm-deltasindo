            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end">
                                <form  action="{{ route('generateReportByModel') }}">
                                    <div class="row align-items-center g-3">
                                        ...
                                        <input type="text" name="model" class="form-control" value="call" hidden>
                                        <div class="col-auto">
                    ...
                    <div class="table-responsive">
                        <table id="dataTableExample" class="table nowrap call-view">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Action</th>
                            ...
                            <tbody>
                                @foreach ($call as $x)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('call.edit', ['customer_id' => $x->customer->id, 'id' => $x->id]) }}"
                                            class="btn btn-primary">Edit</a>
                                        <a href="{{ route('call.destroy', ['customer_id' => $x->customer->id, 'id' => $x->id]) }}"
                                            onclick="event.preventDefault(); document.getElementById('call-delete-{{ $x->id }}').submit();"
                                            class="btn btn-danger">Hapus
                                        </a>
                                        <form id="call-delete-{{ $x->id }}"
...
@push('custom-scripts')
    ...
    // make filter for datatable by date range , className=.call-view

                            ...
                            <div class="d-flex justify-content-end">
                                <form  action="{{ route('generateReportByModel') }}">
                                    <div class="row align-items-center g-3">
                                        ...
                                        <input type="text" name="model" class="form-control" value="preorder" hidden>
                                        <div class="col-auto">
                            ...
                            <tbody>
                                @foreach ($preorder as $x)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('preorder.edit', ['customer_id' => $x->customer->id, 'id' => $x->id]) }}"
                                            class="btn btn-primary">Edit</a>
                                        <a href="{{ route('preorder.destroy', ['customer_id' => $x->customer->id, 'id' => $x->id]) }}"
                                            onclick="event.preventDefault(); document.getElementById('preorder-delete-{{ $x->id }}').submit();"
                                            class="btn btn-danger">Hapus
                                        </a>
                                        <form id="preorder-delete-{{ $x->id }}"
